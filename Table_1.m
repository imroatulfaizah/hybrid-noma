clear all
close all
M=3; %this is the number of users, you can change with another count.
hall = ones(1,M); %all the channels
Dall = [8 12 16]; %all the deadlines
N = 12; %number of bits
w = [1 1 1]/3; %you need to change this for different weighting coefficients, for example [1 2 3]/6;
